...
def main():
    ...
    music.append(pygame.mixer.Sound('Options/GFF.ogg'))
    music.append(pygame.mixer.Sound('Options/BW.ogg'))
    music.append(pygame.mixer.Sound('Options/RX.ogg'))
    music.append(pygame.mixer.Sound('Options/BS.ogg'))
    music.append(pygame.mixer.Sound('Options/MZ.ogg'))
    ...
    left_boundary = 200
    right_boundary = width - 200
    boundary_color = (150, 0, 0)
    current_height_color = (200, 200, 200)
    dead_line_height = height
    dead_line_color = (200, 0, 0)
    dead_line_appeared = False
    dead_line_delay = 15000
    dead_line_delay_start = 0
    dead_line_speed = 0.05
    ...
    shape = pymunk.Segment(space.static_body, (-width, height), (width * 2, height), 1.0)
